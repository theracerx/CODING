export class AccuWeather extends HTMLElement {
    ...
    generalInfo1 = this.newElem("div", { props: { className: "generalInfo1" }, appendTo: this });
    generalInfo2 = this.newElem("div", { props: { className: "generalInfo2", update: () => { } }, appendTo: this });
    generalInfo3 = this.newElem("div", { props: { className: "generalInfo3" }, appendTo: this });
    ...
    setupStation(apiKey, locKey) {
        ...
        if (locKey) {
            ...
            throw new Error("locKey is required");
    ...
    newElem(type, obj) {
        if (type) {
            ...
            throw new Error("New elem type cannot be undefined");
    }
    addPEAS(elem, obj) {
...
//# sourceMappingURL=accuWeatherHomeUse.js.map